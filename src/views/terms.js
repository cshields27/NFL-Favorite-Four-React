      ...
      <div className="about-content">
        <div className="about-card">
          ...
          <p>
            ...
            All users are expected to engage with the platform in good faith. Misuse, including but not limited to cheating or gambling, will result in account suspension or termination.
            <br/><br/>

            <strong>4. Prohibition on Gambling</strong><br/>
            Favorite Four is intended solely for entertainment purposes and may not be used in connection with any form of gambling or wagering. Users are strictly prohibited from using the platform for gambling or any illegal activities.
            <br/><br/>

            <strong>5. Termination and Account Cancellation:</strong><br/>
            ...
            <strong>7. Governing Law and Jurisdiction:</strong><br/>
