      ...
      <header data-thq="thq-navbar" className="navbar-navbar">
        ...
        <div data-thq="thq-mobile-menu" className="navbar-mobile-menu">
          ...
          >
            ...
            >
              <span className="navbar-text2">{props.text}</span>
              <span className="navbar-text3">{props.text1}</span>
              <span className="navbar-text4">{props.text2}</span>
              <span className="navbar-text5">{props.text3}</span>
