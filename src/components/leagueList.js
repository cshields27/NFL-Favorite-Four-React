    ...
    members.forEach((member) => {
      ...
      if (memberInfo) {
        ...
        const row = [
          ...
          favorite_matchup.spread <= 0 ? favorite_matchup.spread : -1 * favorite_matchup.spread,
          favoriteStatus,
          underdog_matchup.spread <= 0 ? underdog_matchup.away_team : underdog_matchup.home_team,
          underdog_matchup.spread <= 0 ? -1 * underdog_matchup.spread : underdog_matchup.spread,
          underdogStatus,
